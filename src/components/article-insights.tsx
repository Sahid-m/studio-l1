...
const readabilityData = {
  score: 65, // Flesch-Kincaid Reading Ease
...
export function ArticleInsights({ article, onWheel }: { article: Article, onWheel: (e: React.WheelEvent<HTMLDivElement>) => void }) {
  return (
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
                <div className="flex flex-col items-center justify-center text-center p-4 rounded-lg bg-muted/50">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">Higher is easier</p>
                </div>
                 <div className="flex flex-col items-center justify-center text-center p-4 rounded-lg bg-muted/50">
                 ...
                 <div className="flex flex-col items-center justify-center text-center p-4 rounded-lg bg-muted/50">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">Based on 200 WPM</p>
                </div>
            </CardContent>
          </Card>
        </div>
