...
export function PaperCard({ paper }: { paper: ClinicalTrialPaper }) {
  ...
  return (
    <Card className="flex flex-col h-full w-full overflow-hidden border-0 shadow-none rounded-none md:rounded-lg md:border md:shadow-sm bg-card">
    <CardHeader className="relative p-0">
        ...
        <div className="absolute bottom-0 p-6 w-full">
            <div className="flex items-center gap-2 mb-2">
                <Badge variant="outline" className="border-primary text-primary backdrop-blur-sm bg-background/50">{paper.phase}</Badge>
